...
rule execution health does not show.
...
[Supported SIEMs](#supported-siems) | [Docs](#docs)
...
| missing fields | rule-declared fields are absent from source mappings | parser, integration, or content owner |
